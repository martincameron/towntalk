...
public class Sample {
	...
	public String name = "";
	public int idx, volume = 0, panning = -1, relNote = 0, fineTune = 0;
	private int loopStart = DELAY, loopLength = 0;
	...
	public void getSampleData( byte[] output, int offset, int length ) {
		int idx = DELAY;
