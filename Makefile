...
ttfp: tt.c towntalk.c towntalk.h optimizer.c worker.c worker.h ttasm.c ttasm.h
	$(CC) $(CFLAGS) $(ANSI_C) $(PTHREADS) $(MATHS) -DMULTI_THREAD -DFLOATING_POINT -DOPTIMIZER -DASM_STATEMENT tt.c towntalk.c optimizer.c worker.c ttasm.c -o ttfp

ttfx: ttfx.c towntalk.c towntalk.h optimizer.c worker.c worker.h ttasm.c ttasm.h
	$(CC) $(CFLAGS) $(MATHS) -DMULTI_THREAD -DFLOATING_POINT -DOPTIMIZER -DASM_STATEMENT ttfx.c towntalk.c optimizer.c worker.c ttasm.c -o ttfx `sdl2-config --cflags --libs`
